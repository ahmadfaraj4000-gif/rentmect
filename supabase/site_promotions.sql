...
create table if not exists public.site_promotions (
  ...
  cta_url text not null default 'cars.html',
  fine_print text,
  ...
  banner_pages text[] not null default array['cars.html']::text[],
  ...
  check (popup_pages <@ array['index.html', 'cars.html']::text[]),
  check (banner_pages <@ array['index.html', 'cars.html']::text[]),
