...
check('Bonzah is the recommended homepage insurance option',
  /<article class="insurance-card recommended-insurance">[\s\S]*?<div class="insurance-recommended-badge">Recommended<\/div>[\s\S]*?<h3>Bonzah Insurance<\/h3>/.test(home));
check('Bonzah is the recommended cars-2 insurance option',
  /<a class="recommended" href="https:\/\/bonzah\.com\/[\s\S]*?<span class="cars2-insurance-badge">Recommended<\/span>[\s\S]*?<strong>Bonzah<\/strong>/.test(cars2Html));
